...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#FFF3E0] text-[#FFB300] pr-3 pt-3 pb-3 inline-flex justify-between items-center w-full h-18 shadow-xl transition-all duration-300 ease-in-out hover:drop-shadow-2xl rounded-b-3xl z-10'>
      <div className='Logo pl-1'><img className='w-20 p-2 rounded-full file:drop-shadow-2xl' src='Aai ji honey.jpg'></img></div>
      <nav className="space-x-4 pr-4 items-center justify-center font-semibold">
